...
function BrowserViewController(view, game) {
    ...
    // Open cell 
    this._view.eventDispatcher.subscribe(MinesweeperGame.UPDATE_CELL_STATUS, function() {
    ...
    // Switching a flag
    this._view.eventDispatcher.subscribe(MinesweeperGame.CELL_MARKED, function() {
